...
<figure markdown="span">
    ![Example of gmx cluster size distribution](../../assets/GROMACS/clust/gmx_cluster_01.png)
...
<figure markdown="span">
    ![Formula for cluster occupancy](../../assets/GROMACS/clust/gmx_cluster_02.png){ width="400" }
</figure>
